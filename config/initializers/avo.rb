...
Avo.configure do |config|
  ...
  #config.home_path = -> { '/avo/dashboards' }
  #config.home_path = -> { Avo::Engine.routes.url_helpers.dashboards_path }
  ...
  config.current_user_method = :current_user
  config.authenticate_with do
    authenticate_user! if defined?(authenticate_user!)
